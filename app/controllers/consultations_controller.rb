class ConsultationsController < ApplicationController
  ...
  private
    ...
    def consultation_params
      params.require(:consultation).permit(:patient_name, :patient_id, :date, :sittings, :current_compliant, :imp_pat_info, :init_diagnosis, :alt_diagnosis, :remarks, :current_medication, :next_consult_date)
    end
end
